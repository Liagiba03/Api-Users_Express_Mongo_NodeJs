...
const {createUser, getUsers, getUserId, getUserName, setUpdateUser, deleteUser} = require('../Service/usersService.js');
...
module.exports = {createUserController, getUsersController, getUserIdController, getUserNameController, setUpdateUserController, deleteUserController};